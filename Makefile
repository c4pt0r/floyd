...
test-deepseek-v4-ds4-q8-tiny-mm: floyd
	@test -n "$(DSPARK)" || (echo "set DSPARK=/path/to/DeepSeek-V4-Flash-DSpark"; exit 2)
	sh tests/test_deepseek_v4_ds4_q8_tiny_mm.sh "$(DSPARK)"
