...
DS4_PATCHES = patches/ds4/deepseek-v4-dspark-quantizer.patch \
	...
	patches/ds4/deepseek-v4-top2-margin.patch \
	patches/ds4/deepseek-v4-margin-trace.patch
