...
int main(int argc, char **argv) {
    ...
    CHECK(kernel_stats.head_norm_rope_calls >= 43);
    CHECK(kernel_stats.tiny_batch_head_norm_rope_calls >= 43);
    printf("DeepSeek V4 DSpark tiny batch fusion: moe_calls=%llu "
           ...
           "exact_q8_calls=%llu head_norm_rope_calls=%llu "
           "batch_head_norm_rope_calls=%llu\n",
           ...
           (unsigned long long)kernel_stats.head_norm_rope_calls,
           (unsigned long long)kernel_stats.tiny_batch_head_norm_rope_calls);
