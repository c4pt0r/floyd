...
int main(int argc, char **argv) {
    ...
    CHECK(kernel_stats.tiny_batch_q2_down_wide_calls >= 43);
    ...
    printf("DeepSeek V4 DSpark tiny batch fusion: moe_calls=%llu q2_wide_calls=%llu "
           ...
           (unsigned long long)kernel_stats.tiny_batch_q2_down_wide_calls,
