...
int main(int argc, char **argv) {
    ...
    CHECK(kernel_stats.tiny_batch_exact_q4_calls > 0);
    ...
    printf("DeepSeek V4 DSpark tiny batch fusion: moe_calls=%llu "
           ...
           "exact_q8_calls=%llu exact_q4_calls=%llu q8_pair_calls=%llu\n",
           ...
           (unsigned long long)kernel_stats.tiny_batch_exact_q4_calls,
