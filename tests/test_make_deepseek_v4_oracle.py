...
from tools.make_deepseek_v4_oracle import PROMPT_IDS, build_tiny, write_tiny
...
def test_write_tiny_is_complete_and_deterministic():
    with tempfile.TemporaryDirectory() as first, tempfile.TemporaryDirectory() as second:
        ...
        with safe_open(fixture / "oracle.safetensors", framework="pt") as oracle:
            ...
            assert oracle.get_slice("attn.0.keys").get_shape() == [n_tokens, 16]


if __name__ == "__main__":
    test_build_tiny()
    test_write_tiny_is_complete_and_deterministic()
    print("DeepSeek V4 oracle builder tests: ok")
