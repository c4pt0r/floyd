...
def test_three_stage_template_reuses_ds4_quant_layout():
    ...
    assert by_name["mtp.0.attn_q_a.weight"].quant_type == "F16"
    assert by_name["mtp.1.attn_q_b.weight"].quant_type == "F16"
    assert by_name["mtp.2.attn_kv.weight"].quant_type == "F16"
    assert by_name["mtp.2.attn_output_a.weight"].quant_type == "F16"
    assert by_name["mtp.2.attn_output_b.weight"].quant_type == "F16"
    ...
    assert by_name["mtp.2.markov_head.markov_w1.weight"].quant_type == "F16"
