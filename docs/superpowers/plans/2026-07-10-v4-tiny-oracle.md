...
**Files:**
- Create: `tools/make_v4_oracle.py`
- Create: `tests/test_make_v4_oracle.py`
- Modify: `Makefile`
...
Run: `PYTHON=/Users/dongxu/floyd/.venv/bin/python make test-v4-oracle`

Expected: import fails because `tools.make_v4_oracle` is absent.
...
**Files:**
- Modify: `tools/make_v4_oracle.py`
- Modify: `tests/test_make_v4_oracle.py`
...
```bash
PYTHON=/Users/dongxu/floyd/.venv/bin/python make test-v4-oracle
/Users/dongxu/floyd/.venv/bin/python tools/make_v4_oracle.py tiny
make tools/probe_safetensors
tools/probe_safetensors fixture_tiny_v4
```
...
```bash
git add Makefile README.md tools/make_v4_oracle.py tests/test_make_v4_oracle.py docs/superpowers/specs/2026-07-10-v4-tiny-oracle-design.md docs/superpowers/plans/2026-07-10-v4-tiny-oracle.md
