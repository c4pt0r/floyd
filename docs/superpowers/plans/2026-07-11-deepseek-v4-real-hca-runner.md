...
1. Extend `tools/make_deepseek_v4_forward_oracle.py` and
   `tests/test_deepseek_v4_forward.py` with a real 128-token layer-3 capture. Run the
...
3. Extend `tests/test_deepseek_v4_forward.c` with the caller-owned layer state API and
