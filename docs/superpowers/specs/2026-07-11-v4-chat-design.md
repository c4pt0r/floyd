...
reuse the numerically verified primitives in `v4_real_layer0.h`, but chat code
must call a stable prefill/decode interface rather than fixture capture helpers.

`v4_chat.c` provides the executable. It renders the official minimal chat-mode
format:
